...
public class HmTextViewWithImage extends AppCompatTextView {
    ...
    private static final Spannable.Factory f38027L = Spannable.Factory.getInstance();

    /* renamed from: M, reason: collision with root package name */
    private static int f38028M = 0;
    ...
    private static Spannable v(Context context, CharSequence charSequence) {
        Spannable newSpannable = f38027L.newSpannable(charSequence);
