...
public final class ColorPickerView extends View {
    ...
    @l3.d
    private final int[] f46407F;

    /* renamed from: G, reason: collision with root package name */
    @l3.d
    private final GradientDrawable f46408G;

    /* renamed from: H, reason: collision with root package name */
    @l3.d
    private final GradientDrawable f46409H;

    /* renamed from: I, reason: collision with root package name */
    @l3.d
    private final Paint f46410I;

    /* renamed from: J, reason: collision with root package name */
    @l3.d
    private final Paint f46411J;

    /* renamed from: K, reason: collision with root package name */
    @l3.d
    private final Paint f46412K;
    ...
    private float f46417P;

    /* renamed from: Q, reason: collision with root package name */
    private float f46418Q;

    /* renamed from: R, reason: collision with root package name */
    private float f46419R;

    /* renamed from: S, reason: collision with root package name */
    private float f46420S;

    /* renamed from: T, reason: collision with root package name */
    private float f46421T;

    /* renamed from: U, reason: collision with root package name */
    private final float f46422U;

    /* renamed from: V, reason: collision with root package name */
    private float f46423V;

    /* renamed from: W, reason: collision with root package name */
    @e
    private l<? super Color, H0> f46424W;

    /* renamed from: a0, reason: collision with root package name */
    private boolean f46425a0;
    ...
    private final void a(MotionEvent motionEvent) {
        double x3 = motionEvent.getX() - this.f46414M;
        double y3 = motionEvent.getY() - this.f46415N;
        float f4 = 360;
        n((o((float) Math.atan2(y3, x3)) + f4) % f4, Math.min((float) Math.hypot(x3, y3), this.f46416O) / this.f46416O);
    }
    ...
    private final void c(Canvas canvas) {
        float f4 = this.f46422U - this.f46423V;
        this.f46412K.setColor(getRgb());
        canvas.drawCircle(this.f46420S, this.f46421T, f4, this.f46412K);
    }

    private final void d(Canvas canvas) {
        this.f46408G.draw(canvas);
        this.f46409H.draw(canvas);
    }

    private final void e(Canvas canvas) {
        canvas.drawCircle(this.f46414M, this.f46415N, this.f46417P, this.f46410I);
    }

    private final void f(Canvas canvas) {
        float[] fArr = this.f46413L;
        float f4 = fArr[1] * this.f46416O;
        double p4 = p(fArr[0]);
        this.f46420S = (((float) Math.cos(p4)) * f4) + this.f46414M;
        this.f46421T = (((float) Math.sin(p4)) * f4) + this.f46415N;
        h(canvas);
    }

    private final void g(Canvas canvas) {
        canvas.drawCircle(this.f46420S, this.f46421T, this.f46422U, this.f46411J);
    }

    private final int getRgb() {
        return android.graphics.Color.HSVToColor(this.f46413L);
    }
    ...
    private final void i() {
        ...
        l<? super Color, H0> lVar = this.f46424W;
        if (lVar != null) {
            lVar.C(color);
        }
    }
    ...
    private final void k(MotionEvent motionEvent) {
        ...
        q(motionEvent);
        this.f46418Q = motionEvent.getX();
        this.f46419R = motionEvent.getY();
    }
    ...
    private final void n(float f4, float f5) {
        ...
        float H4;
        float[] fArr = this.f46413L;
        H3 = u.H(f4, 0.0f, 360.0f);
        fArr[0] = H3;
        float[] fArr2 = this.f46413L;
        H4 = u.H(f5, 0.0f, 1.0f);
        fArr2[1] = H4;
    }
    ...
    private final void setRgb(int i4) {
        android.graphics.Color.colorToHSV(i4, this.f46413L);
    }
    ...
    protected void onSizeChanged(int i4, int i5, int i6, int i7) {
        ...
        this.f46414M = getPaddingLeft() + (paddingLeft / 2);
        this.f46415N = getPaddingTop() + (paddingTop / 2);
        int max = Math.max(Math.min(paddingLeft, paddingTop) / 2, 0) - ((int) this.f46422U);
        this.f46416O = max;
        int i8 = this.f46414M;
        int i9 = i8 - max;
        int i10 = this.f46415N;
        int i11 = i10 - max;
        int i12 = i8 + max;
        int i13 = i10 + max;
        this.f46408G.setBounds(i9, i11, i12, i13);
        this.f46409H.setBounds(i9, i11, i12, i13);
        this.f46409H.setGradientRadius(this.f46416O);
        this.f46417P = this.f46416O + b(10.85f);
    }
    ...
    */
    public boolean onTouchEvent(@l3.d android.view.MotionEvent r4) {
        ...
        L38:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.harman.jbl.partylight.lib.dashboard.widget.ColorPickerView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public final void setColor(@l3.d Color color) {
        F.p(color, "color");
        setRgb(android.graphics.Color.rgb(color.i(), color.h(), color.g()));
        this.f46425a0 = true;
        invalidate();
    }

    public final void setListener(@l3.d l<? super Color, H0> l4) {
        F.p(l4, "l");
        this.f46424W = l4;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ColorPickerView(@l3.d Context context, @e AttributeSet attributeSet) {
        ...
        this.f46408G = gradientDrawable;
        GradientDrawable gradientDrawable2 = new GradientDrawable();
        gradientDrawable2.setGradientType(1);
        gradientDrawable2.setShape(1);
        gradientDrawable2.setColors(iArr2);
        this.f46409H = gradientDrawable2;
        Paint paint = new Paint();
        paint.setAntiAlias(true);
        paint.setColor(C0669d.f(context, g.c.f46644v));
        Paint.Style style = Paint.Style.FILL;
        paint.setStyle(style);
        this.f46410I = paint;
        Paint paint2 = new Paint();
        paint2.setAntiAlias(true);
        paint2.setColor(C0669d.f(context, g.c.f46616D));
        ...
        this.f46412K = paint3;
        this.f46413L = new float[]{0.0f, 0.0f, 1.0f};
        this.f46422U = b(24.0f);
        this.f46423V = b(5.0f);
        this.f46425a0 = true;
    }
}
