...
public final class ForegroundMaskLayout extends LinearLayout implements View.OnClickListener {
    ...
    public ForegroundMaskLayout(@l3.d Context context, @l3.e AttributeSet attributeSet) {
        ...
        F.p(context, "context");
        this.f45770E = true;
        this.f45771F = Color.parseColor("#B3121111");
        if (this.f45770E) {
            a();
        }
    }
    ...
    public final void a() {
        com.harman.log.f.a(f45769H, "mask() called:");
        this.f45770E = true;
        setForeground(new ColorDrawable(this.f45771F));
        setOnClickListener(this);
        invalidate();
    }

    public final void b() {
        com.harman.log.f.a(f45769H, "unmask() called:");
        this.f45770E = false;
        setForeground(null);
