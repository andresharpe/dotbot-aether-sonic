...
public final class ElasticScrollView extends ScrollView {
    ...
    @l3.e
    private View f45759H;

    /* renamed from: I, reason: collision with root package name */
    @l3.e
    private View f45760I;

    /* renamed from: J, reason: collision with root package name */
    private float f45761J;
    ...
    private final int c(MotionEvent motionEvent) {
        ...
        if (Math.abs(y3 - this.f45761J) > 3.0f) {
            i4 = (int) ((this.f45761J - y3) / this.f45757F);
        } else {
            i4 = 0;
        }
        this.f45761J = y3;
    ...
    private final void d(MotionEvent motionEvent) {
        ...
        this.f45761J = motionEvent.getY();
    }

    private final ValueAnimator e(final View view, int i4, int i5) {
        ValueAnimator ofInt = ValueAnimator.ofInt(i4, i5);
        ofInt.setDuration(this.f45758G);
        ofInt.setInterpolator(new OvershootInterpolator());
        ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.harman.jbl.partybox.ui.widget.j
    ...
    private final ValueAnimator g(final View view, int i4, int i5) {
        ...
        ofInt.setDuration(this.f45758G);
        ofInt.setInterpolator(new OvershootInterpolator());
        ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.harman.jbl.partybox.ui.widget.k
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    private final void i(MotionEvent motionEvent) {
        ...
        if (k(c4) && this.f45760I != null) {
            o(c4);
        }
    }

    private final void j() {
        if (n() && this.f45760I != null) {
            q();
        }
    }
    ...
    private final void p(View view) {
        ...
        if (view2 != null) {
            ...
            layoutParams.height = this.f45762K;
            layoutParams.width = this.f45763L;
            View view3 = this.f45760I;
            F.m(view3);
            view3.setLayoutParams(layoutParams);
        }
        if (view != null) {
            this.f45762K = view.getLayoutParams().height;
            this.f45763L = view.getLayoutParams().width;
        }
    }
    ...
    private final void q() {
        View view = this.f45760I;
        F.m(view);
        ValueAnimator e4 = e(view, view.getHeight(), this.f45762K);
        View view2 = this.f45760I;
        F.m(view2);
        ValueAnimator g4 = g(view2, view2.getWidth(), this.f45763L);
