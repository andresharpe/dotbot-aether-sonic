...
public class HmTextViewWithImage extends AppCompatTextView {
    ...
    private static final Spannable.Factory f42589L = Spannable.Factory.getInstance();

    /* renamed from: M, reason: collision with root package name */
    private static int f42590M = 0;
    ...
    private static Spannable v(Context context, CharSequence charSequence) {
        Spannable newSpannable = f42589L.newSpannable(charSequence);
