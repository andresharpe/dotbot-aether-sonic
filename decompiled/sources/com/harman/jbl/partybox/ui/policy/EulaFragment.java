...
public final class EulaFragment extends BackDispatcherFragment {
    ...
    @d
    private final FragmentViewBindingDelegate f45504Q0;

    /* renamed from: R0, reason: collision with root package name */
    @d
    private final A f45505R0;

    /* renamed from: S0, reason: collision with root package name */
    static final /* synthetic */ n<Object>[] f45503S0 = {N.u(new PropertyReference1Impl(EulaFragment.class, "binding", "getBinding()Lcom/harman/jbl/partybox/databinding/FragmentEulaBinding;", 0))};
    ...
    /* synthetic */ class b extends FunctionReferenceImpl implements l<View, C1892k0> {
        ...
        public static final b f45506N = new b();
    ...
    public static final class c implements CollapsingToolBar.b {
        ...
        @Override // com.harman.jbl.partybox.ui.widget.CollapsingToolBar.b
        public void b() {
            EulaFragment.this.onBtnBackClick();
        }
    }

    public EulaFragment() {
        super(j.i.f41475b0);
        this.f45504Q0 = com.harman.jbl.partybox.ui.delegate.b.a(this, b.f45506N);
        this.f45505R0 = ApplicationViewModelLazyKt.f(this, N.d(o.class), new ApplicationViewModelLazyKt$applicationViewModels$3(this), new ApplicationViewModelLazyKt$applicationViewModels$4(this));
    }
    ...
    private final C1892k0 p0() {
        return (C1892k0) this.f45504Q0.a(this, f45503S0[0]);
    }

    private final o q0() {
        return (o) this.f45505R0.getValue();
    }

    private final void r0(final String str, String str2) {
        int p32;
        Resources.Theme theme;
        T1.a.a("EulaFragment showText content = " + str2);
        SpannableString spannableString = new SpannableString(str2);
        String spannableString2 = spannableString.toString();
        F.o(spannableString2, "toString(...)");
        p32 = kotlin.text.A.p3(spannableString2, str, 0, false, 6, null);
        View.OnClickListener onClickListener = new View.OnClickListener() { // from class: com.harman.jbl.partybox.ui.policy.a
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                EulaFragment.s0(str, this, view);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void s0(String url, EulaFragment this$0, View view) {
        F.p(url, "$url");
        F.p(this$0, "this$0");
    ...
    private final void t0(String str) {
        T1.a.a("EulaFragment updateText content = " + str);
    ...
    public void onViewCreated(@d View view, @e Bundle bundle) {
        ...
        p0().f39760F.setTitleText(getString(j.m.K7));
        ...
        if (activity != null) {
            try {
                ...
                LegalConfig.Type type = LegalConfig.Type.EULA;
                m mVar = m.f46192a;
                Resources resources = getResources();
                F.o(resources, "getResources(...)");
                String k4 = dVar.k(applicationContext, type, mVar.c(resources));
                T22 = kotlin.text.A.T2(k4, S1.a.f1735c, false, 2, null);
                if (T22) {
                    T1.a.a("EulaFragment It is EULA Link");
                    r0(S1.a.f1735c, k4);
                } else {
                    T1.a.a("EulaFragment It is EULA content");
                    t0(k4);
                }
                H0 h02 = H0.f51801a;
            } catch (Exception e4) {
                e4.printStackTrace();
                Log.d(TAG, H0.f51801a.toString());
            }
        }
    }
}
