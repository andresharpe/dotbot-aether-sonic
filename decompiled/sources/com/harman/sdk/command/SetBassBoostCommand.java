...
public final class SetBassBoostCommand extends BaseCommand {
    ...
    public BaseMessage q(@d HmDevice device, @d com.harman.sdk.a receivedCommand) {
        ...
        if (n4 != null && n4.length > 1 && 99 == n4[0] && receivedCommand.k() == 0) {
            v().clear();
