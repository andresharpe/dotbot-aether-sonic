...
public final class zzkp {
    ...
    static {
        ...
        zzd = zzkpVar4;
        zzkp zzkpVar5 = new zzkp("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(com.google.firebase.remoteconfig.l.f37524n));
        zze = zzkpVar5;
        ...
        zzg = zzkpVar7;
        zzkp zzkpVar8 = new zzkp("BYTE_STRING", 7, zzjd.class, zzjd.class, zzjd.f29849F);
        zzh = zzkpVar8;
    ...
    private zzkp(String str, int i4, Class cls, Class cls2, Object obj) {
        this.zzl = cls;
        this.zzm = cls2;
        this.zzn = obj;
    }
