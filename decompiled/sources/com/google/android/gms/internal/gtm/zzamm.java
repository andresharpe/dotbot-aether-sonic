...
public enum zzamm implements zzbfh {
    ...
    TYPE_SUBLOCALITY(38),
    TYPE_US_BOROUGH(v.e.f7493y),
    TYPE_GB_DEPENDENT_LOCALITY(v.e.f7494z),
    TYPE_JP_OOAZA(614),
    TYPE_JP_KOAZA(615),
    TYPE_JP_GAIKU(616),
    ...
    TYPE_INDUSTRIAL(101),
    TYPE_MILITARY(102),
    TYPE_SHOPPING_CENTER(a.b.f43494d),
    TYPE_SPORTS_COMPLEX(104),
    TYPE_UNIVERSITY_GROUNDS(105),
    TYPE_DEPRECATED_TARMAC(a.b.f43497g),
    ...
    TYPE_TERRAIN(GestureInfo.f48258r0),
    TYPE_SAND(2577),
    TYPE_BEACH(41233),
    TYPE_DUNE(41234),
    TYPE_ROCKY(2578),
    ...
    TYPE_DESERT(2583),
    TYPE_SALT_FLAT(2584),
    TYPE_WATER(GestureInfo.f48259s0),
    TYPE_OCEAN(2593),
    TYPE_BAY(41489),
    TYPE_BIGHT(663825),
    TYPE_LAGOON(663826),
    ...
    TYPE_TECTONIC(GestureInfo.f48260t0),
    TYPE_WATERING_HOLE_DEPRECATED(2608),
    TYPE_VOLCANO(2609),
    TYPE_LAVA_FIELD(2610),
    TYPE_FISSURE(2611),
    TYPE_FAULT(2612),
    TYPE_LAND_MASS(GestureInfo.f48261u0),
    TYPE_CONTINENT(2625),
    TYPE_ISLAND(2626),
    TYPE_ATOLL(42017),
    ...
    TYPE_PENINSULA(2627),
    TYPE_ISTHMUS(2628),
    TYPE_ELEVATED(GestureInfo.f48262v0),
    TYPE_PEAK(2641),
    TYPE_NUNATAK(42257),
    TYPE_SPUR(42258),
    TYPE_PASS(2642),
    ...
    TYPE_UNDERSEA(GestureInfo.f48263w0),
    ...
    TYPE_POSTAL(11),
    TYPE_POSTAL_CODE(com.harman.analytics.deviceAws.a.f37830m),
    ...
    TYPE_ADDRESS_TEMPLATE(n.f.f18255b),
    TYPE_TRANSIT_AGENCY(3217),
    TYPE_FUTURE_GEOMETRY(a.c.f43510c),
    TYPE_EVENT(208),
    ...
    TYPE_DO_NOT_USE_RESERVED_TO_CATCH_GENERATED_FILES(GestureInfo.f48245e0),
    TYPE_UNKNOWN(255);
    ...
    public static zzamm zzb(int i4) {
        if (i4 == 0) {
            return TYPE_ANY;
        }
        if (i4 == 1) {
