...
public enum zzbjc implements zzbfh {
    ...
    UC_PROTO_METADATA(1),
    UC_DELEGATED(2),
    UC_RESERVED_FOR_TESTING_IN_PRODUCT_CONTROL(a.f37831n),
    UC_NEVER_COLLECT(3),
    UC_1P_APP_PROVISION_OF_SERVICE(194),
    UC_3P_APP_PROVISION_OF_SERVICE(a.c.f43511d),
    ...
    UC_PLATFORM_OR_FEATURE_MEASURING_USER_ENGAGEMENT_WW(a.b.f43494d),
    UC_SERVICE_OR_API_FUNCTIONAL_DEBUGGING_WW(104),
    UC_SERVICE_OR_API_PRODUCT_IMPROVEMENT_WW(105),
    UC_SERVICE_OR_API_PRODUCT_DEVELOPMENT_WW(a.b.f43497g),
    ...
    UC_APP_USAGE_PERSONALIZATION_WW(q.f54649c),
    ...
    UC_PLATFORM_OR_FEATURE_PRODUCT_IMPROVEMENT(i.f4871X),
    ...
    UC_INTERNAL_DESCRIPTION(GestureInfo.f48264x0),
    ...
    UC_ACCOUNT_INTEGRITY(a.b.f43498h),
    UC_FRAUD_SPAM_ABUSE_PREVENTION(146),
    UC_DROIDGUARD_VERDICT_INPUT(L1.a.f1556a),
    UC_PLAY_MALWARE_DETECTION(com.harman.analytics.deviceAws.a.f37828k),
    ...
    UC_REFINING_EXPERIMENTS(GestureInfo.f48257q0),
    ...
    UC_PRIMES_APP_HEALTH(com.harman.analytics.deviceAws.a.f37826i),
    UC_CHIME_FUNCTIONAL_DEBUGGING(a.c.f43514g),
    UC_CHIME_PRODUCT_IMPROVEMENT(207),
    UC_CHIME_MEASURING_USER_ENGAGEMENT(a.c.f43513f),
    UC_CHIME_NOTIFICATION_MANAGEMENT(289),
    UC_1P_APP_FUNCTIONAL_DEBUGGING(com.harman.analytics.deviceAws.a.f37827j),
    ...
    UC_SDK_PRODUCT_IMPROVEMENT(n.f.f18255b),
    UC_SDK_PRODUCT_DEVELOPMENT(a.c.f43509b),
    UC_SDK_MEASURING_USER_ENGAGEMENT(a.c.f43510c),
    UC_FCM_FUNCTIONAL_DEBUGGING(192),
    UC_FCM_MESSAGE_DELIVERY(280),
    UC_FIT_FUNCTIONAL_DEBUGGING(com.harman.analytics.deviceAws.a.f37830m),
    ...
    UC_GBOARD_FUNCTIONAL_DEBUGGING(GestureInfo.f48258r0),
    UC_GBOARD_PRODUCT_IMPROVEMENT(GestureInfo.f48259s0),
    UC_GBOARD_PRODUCT_DEVELOPMENT(GestureInfo.f48260t0),
    UC_GBOARD_MEASURING_USER_ENGAGEMENT(GestureInfo.f48261u0),
    ...
    UC_GPP_SIDELOADED_UNSAFE_APP_DETECTION(GestureInfo.f48262v0),
    UC_GPP_UNSAFE_APP_DETECTION(GestureInfo.f48263w0),
    ...
    UC_RESTORE_USER_DATA(BatteryInfo.f48169K),
    UC_BACKUP_MANAGEMENT(267),
    UC_WEAR_CLOUD_SYNC(a.c.f43512e),
    ...
    UC_DIGITAL_WELLBEING_MEASURING_USER_ENGAGEMENT(GestureInfo.f48244d0),
    UC_DIGITAL_WELLBEING_PRODUCT_IMPROVEMENT(GestureInfo.f48245e0),
    UC_MARKETING_ENGAGEMENT_GROWTH_COMMS(260),
    UC_MARKETING_ENGAGEMENT_GROWTH_FREQ_CAP(327),
    UC_AUDIT_RECORD(255),
    UC_LOCATION_SHARING(256),
    UC_GMM_PUBLIC_PHOTO(257),
    UC_GMM_PUBLIC_VIDEO(258),
    UC_GMM_USER_INITIATED_FEEDBACK(259),
    UC_GMM_VOTE(305),
    UC_GMM_UGC_PUBLIC_REPORT(306),
    ...
    UC_HEADLESS_DPC_CLOUD_API_RUN_DEVICE_COMMANDS(BaseCommandWiFi.f47637Q),
    ...
    UC_ARES_CONTENT_ABUSE_REPORT(v.a.f7389q),
    UC_ARES_TAKEDOWN_APPEALS(v.a.f7390r),
    UC_FMD_ERASE_DEVICE(v.a.f7391s),
    ...
    UC_MESSAGES_SUPERSORT_PRODUCT_IMPROVEMENT(400),
    ...
    public static zzbjc zzc(int i4) {
        if (i4 == 0) {
            return UC_DEFAULT;
        }
        if (i4 == 1) {
        ...
        switch (i4) {
            ...
            case com.harman.analytics.deviceAws.a.f37827j /* 136 */:
            ...
            case L1.a.f1556a /* 147 */:
                return UC_DROIDGUARD_VERDICT_INPUT;
            case com.harman.analytics.deviceAws.a.f37828k /* 148 */:
            ...
            case GestureInfo.f48257q0 /* 160 */:
                return UC_REFINING_EXPERIMENTS;
            case GestureInfo.f48258r0 /* 161 */:
                return UC_GBOARD_FUNCTIONAL_DEBUGGING;
            case GestureInfo.f48259s0 /* 162 */:
            ...
            case com.harman.analytics.deviceAws.a.f37830m /* 177 */:
            ...
            case com.harman.analytics.deviceAws.a.f37831n /* 197 */:
                        ...
                        switch (i4) {
                            ...
                            default:
                                switch (i4) {
                                    ...
                                    case GestureInfo.f48244d0 /* 253 */:
                                        return UC_DIGITAL_WELLBEING_MEASURING_USER_ENGAGEMENT;
                                    case GestureInfo.f48245e0 /* 254 */:
                                    ...
                                    case BaseCommandWiFi.f47637Q /* 287 */:
