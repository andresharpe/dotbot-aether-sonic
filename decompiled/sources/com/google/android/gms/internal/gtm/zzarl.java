...
public enum zzarl implements zzbfh {
    ...
    SIGNAL_LENGTH(1001),
    SIGNAL_AREA(1002),
    SIGNAL_ADDRESS(C0805e0.f13470f),
    SIGNAL_LISTING(1004),
    SIGNAL_ROAD_PRIORITY(C1576l.f30029x),
    SIGNAL_POI_COUNT(C0805e0.f13472h),
    SIGNAL_WEBSCORE(C0805e0.f13473i),
    SIGNAL_PATHRADIUS_LENGTH_METERS(C0805e0.f13474j),
    SIGNAL_PATHRADIUS_LENGTH_SEGMENTS(C0805e0.f13475k),
    SIGNAL_PATHRADIUS_POPULARITY(C0805e0.f13476l),
    SIGNAL_PEAK_ELEVATION_PROMINENCE(C0805e0.f13477m),
    SIGNAL_ROAD_SEGMENT_COUNT(C0805e0.f13478n),
    SIGNAL_POI_SCORE(C0805e0.f13479o),
    SIGNAL_ATTRACTIONS_SCORE(C0805e0.f13480p),
    SIGNAL_HAND_RANKED_LOCALITY_PROMINENCE(C0805e0.f13481q),
    SIGNAL_POPULATION(1),
    SIGNAL_GDP(2),
    ...
    SIGNAL_GOOGLE_GEOWIKI_USER_RANK(androidx.vectordrawable.graphics.drawable.g.f20307d),
    ...
    public static zzarl zzb(int i4) {
        if (i4 == 0) {
        ...
        switch (i4) {
            ...
            default:
                switch (i4) {
                    ...
                    case androidx.vectordrawable.graphics.drawable.g.f20307d /* 3000 */:
