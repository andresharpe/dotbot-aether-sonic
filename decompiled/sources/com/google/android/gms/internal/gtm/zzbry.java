...
public enum zzbry implements zzbfh {
    ...
    TECHNICAL_IN_DEVELOPMENT_GEO_KG_UGC(C0805e0.f13470f),
    ...
    CONTRACTUAL_CARBON_INDEX_APP(a.b.f43497g),
    ...
    public static zzbry zzc(int i4) {
        if (i4 == 1701) {
                                        ...
                                        switch (i4) {
                                            ...
                                            default:
                                                switch (i4) {
                                                    ...
                                                    default:
                                                        switch (i4) {
                                                            case com.clj.fastble.a.f26980l /* 10000 */:
