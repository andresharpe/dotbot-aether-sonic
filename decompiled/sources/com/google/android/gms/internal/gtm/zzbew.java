...
public final class zzbew extends zzbba implements RandomAccess, zzbfk, zzbha {
    ...
    public final /* bridge */ /* synthetic */ zzbfp zzd(int i4) {
        if (i4 >= this.zzc) {
            return new zzbew(Arrays.copyOf(this.zzb, i4), this.zzc);
        }
    ...
    private zzbew(float[] fArr, int i4) {
        this.zzb = fArr;
        this.zzc = i4;
    }
