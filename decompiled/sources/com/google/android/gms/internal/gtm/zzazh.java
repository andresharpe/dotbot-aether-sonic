...
jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r0v168 com.google.android.gms.internal.gtm.zzazh, still in use, count: 1, list:
  (r0v168 com.google.android.gms.internal.gtm.zzazh) from 0x09dd: SPUT (r0v168 com.google.android.gms.internal.gtm.zzazh) (LINE:2526) com.google.android.gms.internal.gtm.zzazh.zzcO com.google.android.gms.internal.gtm.zzazh
...
public final class zzazh implements zzbfh {
    NONE(0),
    ACCESS_POINT(356),
    ADDRESS(276),
    ...
    BUILDING_DEFAULT_DISPLAY_LEVEL(4915),
    BUILDING_FLOORS(6),
    ...
    FEATURE_TRACK(57),
    FEATURE_TYPE(274),
    FEATURE_WEBSITE(4887),
    FIELD_RIGHTS(29),
    FUTURE_GEOMETRY(66),
    FUTURE_GEOMETRY_FOR(67),
    GCONCEPT(283),
    GEOMETRY_PRECISION_METERS(350),
    INFERRED_GEOMETRY_INCLUDES_GEOMETRY_OF(74),
    INFERRED_GEOMETRY_EXCLUDES_GEOMETRY_OF(75),
    INFERRED_GEOMETRY_DEFINES_GEOMETRY_FOR(76),
    INTERSECTION(73988),
    INTERSECTION_GROUP(4721),
    INTERSECTION_GROUP_CHILD_GROUP(4739),
    INTERSECTION_GROUP_GROUP_TYPE(4738),
    INTERSECTION_GROUP_PARENT_GROUP(4740),
    INTERSECTION_IN_GROUP(4737),
    ...
    POINT(278),
    POLYGON(280),
    POLYGON_FOR_DISPLAY(BaseCommandWiFi.f47637Q),
    POLYLINE(279),
    RANK(354),
    RANK_SIGNAL(355),
    ...
    SEGMENT_CONSTRUCTION_BEGIN_DATE(73991),
    SEGMENT_CONSTRUCTION_END_DATE(73992),
    SEGMENT_CONSTRUCTION_STATUS(4637),
    SEGMENT_COVERED(44),
    SEGMENT_DISTANCE_TO_EDGE(73993),
    ...
    SEGMENT_ROUTE(4673),
    SEGMENT_ROUTE_ASSOCIATION(73989),
    SEGMENT_SEPARATED_ROADWAYS(73986),
    SEGMENT_SURFACE(4632),
    SEGMENT_SWEEP(53),
    SEGMENT_TOLL_ROAD(73987),
    SEGMENT_USAGE(4638),
    ...
    TRANSIT_STATION_AGENCY(84),
    VERTICAL_ORDERING_LEVEL(73),
    DEPRECATED_DO_NOT_USE_EMAIL_ADDRESS(4884),
    DEPRECATED_DO_NOT_USE_RANK_GEOMETRY(286),
    DEPRECATED_DO_NOT_USE_SEGMENT_INFO(74769),
    DEPRECATED_DO_NOT_USE_SEGMENT_LANE_LIST(4785),
    DEPRECATED_DO_NOT_USE_SEGMENT_WRONG_WAY(4625),
    DEPRECATED_DO_NOT_USE_WEBSITE(4883),
    FEATURE_ATTRIBUTE(5266),
    SOCIAL_REFERENCE(19),
    CATEGORY(4882),
    DEPRECATED_DO_NOT_USE_CAPITAL(4497),
    DEPRECATED_DO_NOT_USE_DESCRIPTION(4897),
    ...
    DEPRECATED_DO_NOT_USE_ESTABLISHMENT_TYPE(1249823),
    DEPRECATED_DO_NOT_USE_EVENT(5265),
    ...
    DEPRECATED_DO_NOT_USE_PAYMENT_TYPES(4885),
    DEPRECATED_DO_NOT_USE_PHOTO(4900),
    DEPRECATED_DO_NOT_USE_PHOTO_URL(4898),
    DEPRECATED_DO_NOT_USE_PLACE_CLOSED(4899),
    ...
    public static final zzazh zzcO = new zzazh(349);
    private final int zzcR;
    private static final zzbfi zzcP = new zzbfi() { // from class: com.google.android.gms.internal.gtm.zzazf
    ...
    private zzazh(int i4) {
        this.zzcR = i4;
    }

    public static zzazh[] values() {
        return (zzazh[]) zzcQ.clone();
    }

    public static zzazh zzb(int i4) {
        if (i4 == 0) {
            return NONE;
        }
        if (i4 == 1) {
        ...
        switch (i4) {
            ...
            default:
                switch (i4) {
                    ...
                    case 74:
                        return INFERRED_GEOMETRY_INCLUDES_GEOMETRY_OF;
                    case 75:
                        return INFERRED_GEOMETRY_EXCLUDES_GEOMETRY_OF;
                    case a.f52115i /* 76 */:
    ...
    public final String toString() {
        return Integer.toString(this.zzcR);
    }
