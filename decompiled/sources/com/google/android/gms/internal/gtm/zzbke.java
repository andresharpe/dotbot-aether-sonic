...
public enum zzbke implements zzbfh {
    ...
    ST_ZWIEBACK_ID(1001),
    ST_PREF_ID(1002),
    ST_BISCOTTI_ID(C0805e0.f13470f),
    ST_ANALYTICS_ID(1004),
    ST_MANDELBREAD_ID(C1576l.f30029x),
    ST_ANDROID_LOGGING_ID2(C0805e0.f13472h),
    ST_ACSA_ID(C0805e0.f13473i),
    ST_HERREVAD_ID(C0805e0.f13474j),
    ST_YOUTUBE_VISITOR_ID(C0805e0.f13475k),
    ...
    ST_SOFTWARE_ID(C1231c.f28494g0),
    ST_USER_AGENT(1501),
    ...
    public static zzbke zzd(int i4) {
        if (i4 != 0) {
            if (i4 == 1211) {
                return ST_CHD_PAN;
            }
