...
public enum zzb {
    ...
    LOCALE("locale"),
    LOCATION(FirebaseAnalytics.b.f34811s),
    ...
    QUANTITY(FirebaseAnalytics.b.f34756C),
    QUERY_KEY("query_key"),
    QUERY_LISTS("query_lists"),
    REFERRER(b.c.f48987b),
    ...
    TRANSACTION_ID(FirebaseAnalytics.b.f34759F),
