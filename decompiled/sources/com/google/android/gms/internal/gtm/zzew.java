...
public final class zzew {
    ...
    static {
        ...
        zza = zzev.zza(bool, bool, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzdc
        });
        Boolean bool2 = Boolean.TRUE;
        zzb = zzev.zza(bool2, bool2, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzde
        });
        zzc = zzev.zza("GAv4", "GAv4-SVC", new zzeu() { // from class: com.google.android.gms.internal.gtm.zzdq
        });
        zzd = zzev.zza(60L, 60L, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzec
        });
        Double valueOf = Double.valueOf(0.5d);
        zze = zzev.zza(valueOf, valueOf, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzeh
        });
        zzf = zzev.zza(2000, Integer.valueOf(M.f13329l0), new zzeu() { // from class: com.google.android.gms.internal.gtm.zzei
        });
        ...
        Long valueOf2 = Long.valueOf(C0909k.f15658a);
        zzj = zzev.zza(valueOf2, valueOf2, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzen
        });
        ...
        zzJ = zzev.zza(bool, bool, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzdw
        });
        zzK = zzev.zza(10000L, 10000L, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzdx
        });
        zzL = zzev.zza(valueOf2, valueOf2, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzdz
        });
        zzM = zzev.zza(valueOf2, valueOf2, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzea
        });
        Long valueOf3 = Long.valueOf(b.f44883c);
        zzN = zzev.zza(valueOf3, valueOf3, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzeb
        });
        ...
        zzQ = zzev.zza(valueOf2, valueOf2, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzef
        });
        zzR = zzev.zza(bool, bool, new zzeu() { // from class: com.google.android.gms.internal.gtm.zzeg
        });
    }
}
