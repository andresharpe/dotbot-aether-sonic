...
interface zzbhe {
    ...
    @Deprecated
    void zzF(List list, zzbhf zzbhfVar, zzbep zzbepVar) throws IOException;

    void zzG(List list) throws IOException;

    void zzH(List list) throws IOException;

    void zzI(List list, zzbhf zzbhfVar, zzbep zzbepVar) throws IOException;
    ...
    void zzR(List list) throws IOException;
    ...
    zzbbw zzq() throws IOException;

    @Deprecated
    Object zzr(Class cls, zzbep zzbepVar) throws IOException;

    @Deprecated
    Object zzs(zzbhf zzbhfVar, zzbep zzbepVar) throws IOException;

    Object zzt(Class cls, zzbep zzbepVar) throws IOException;

    Object zzu(zzbhf zzbhfVar, zzbep zzbepVar) throws IOException;
