...
class d {
    ...
    private static final String f35995c = "CrossProcessLock";

    /* renamed from: a, reason: collision with root package name */
    private final FileChannel f35996a;

    /* renamed from: b, reason: collision with root package name */
    private final FileLock f35997b;

    private d(FileChannel fileChannel, FileLock fileLock) {
        this.f35996a = fileChannel;
        this.f35997b = fileLock;
    }
    ...
    */
    public static com.google.firebase.installations.d a(android.content.Context r4, java.lang.String r5) {
        /*
            r0 = 0
            ...
            com.google.firebase.installations.d r1 = new com.google.firebase.installations.d     // Catch: java.nio.channels.OverlappingFileLockException -> L1f java.lang.Error -> L21 java.io.IOException -> L23
    ...
    public void b() {
        try {
            ...
            Log.e(f35995c, "encountered error while releasing, ignoring", e4);
        }
    }
}
