...
public class I implements com.amazonaws.transform.h<com.amazonaws.f<ListIdentitiesRequest>, ListIdentitiesRequest> {
    @Override // com.amazonaws.transform.h
    /* renamed from: b, reason: merged with bridge method [inline-methods] */
    public com.amazonaws.f<ListIdentitiesRequest> a(ListIdentitiesRequest listIdentitiesRequest) {
        if (listIdentitiesRequest != null) {
            com.amazonaws.e eVar = new com.amazonaws.e(listIdentitiesRequest, "AmazonCognitoIdentity");
            eVar.addHeader("X-Amz-Target", "AWSCognitoIdentityService.ListIdentities");
            ...
            try {
                ...
                if (listIdentitiesRequest.r() != null) {
                    String r4 = listIdentitiesRequest.r();
                    b4.l("IdentityPoolId");
                    b4.g(r4);
                }
                if (listIdentitiesRequest.s() != null) {
                    Integer s4 = listIdentitiesRequest.s();
                    b4.l("MaxResults");
                    b4.k(s4);
                }
                if (listIdentitiesRequest.t() != null) {
                    String t3 = listIdentitiesRequest.t();
                    b4.l("NextToken");
                    b4.g(t3);
                }
                if (listIdentitiesRequest.q() != null) {
                    Boolean q4 = listIdentitiesRequest.q();
                    b4.l("HideDisabled");
                    b4.j(q4.booleanValue());
                }
                b4.a();
                b4.close();
