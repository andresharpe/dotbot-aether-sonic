...
/* renamed from: com.amazonaws.services.cognitoidentity.model.transform.y, reason: case insensitive filesystem */
/* loaded from: classes.dex */
public class C1058y implements com.amazonaws.transform.h<com.amazonaws.f<GetOpenIdTokenRequest>, GetOpenIdTokenRequest> {
    @Override // com.amazonaws.transform.h
    /* renamed from: b, reason: merged with bridge method [inline-methods] */
    public com.amazonaws.f<GetOpenIdTokenRequest> a(GetOpenIdTokenRequest getOpenIdTokenRequest) {
        if (getOpenIdTokenRequest != null) {
            com.amazonaws.e eVar = new com.amazonaws.e(getOpenIdTokenRequest, "AmazonCognitoIdentity");
            ...
            try {
                ...
                if (getOpenIdTokenRequest.s() != null) {
                    String s4 = getOpenIdTokenRequest.s();
                    b4.l("IdentityId");
                    b4.g(s4);
                }
                if (getOpenIdTokenRequest.t() != null) {
                    Map<String, String> t3 = getOpenIdTokenRequest.t();
                    b4.l("Logins");
                    b4.b();
