...
public class DescribeIdentityPoolResult implements Serializable {
    ...
    private Map<String, String> f23960I;

    /* renamed from: J, reason: collision with root package name */
    private String f23961J;

    /* renamed from: K, reason: collision with root package name */
    private List<String> f23962K;

    /* renamed from: L, reason: collision with root package name */
    private List<CognitoIdentityProvider> f23963L;

    /* renamed from: M, reason: collision with root package name */
    private List<String> f23964M;

    /* renamed from: N, reason: collision with root package name */
    private Map<String, String> f23965N;
    ...
    public DescribeIdentityPoolResult D(CognitoIdentityProvider... cognitoIdentityProviderArr) {
        if (g() == null) {
            this.f23963L = new ArrayList(cognitoIdentityProviderArr.length);
        }
        for (CognitoIdentityProvider cognitoIdentityProvider : cognitoIdentityProviderArr) {
            this.f23963L.add(cognitoIdentityProvider);
        }
        return this;
    }
    ...
    public DescribeIdentityPoolResult J(String... strArr) {
        if (l() == null) {
            this.f23962K = new ArrayList(strArr.length);
        }
        for (String str : strArr) {
            this.f23962K.add(str);
        }
        return this;
    }
    ...
    public DescribeIdentityPoolResult L(String... strArr) {
        if (m() == null) {
            this.f23964M = new ArrayList(strArr.length);
        }
        for (String str : strArr) {
            this.f23964M.add(str);
        }
        return this;
    }
    ...
    public DescribeIdentityPoolResult a(String str, String str2) {
        if (this.f23965N == null) {
            this.f23965N = new HashMap();
        }
        if (!this.f23965N.containsKey(str)) {
            this.f23965N.put(str, str2);
            return this;
        }
    ...
    public DescribeIdentityPoolResult b(String str, String str2) {
        if (this.f23960I == null) {
            this.f23960I = new HashMap();
        }
        if (!this.f23960I.containsKey(str)) {
            this.f23960I.put(str, str2);
            return this;
        }
        throw new IllegalArgumentException("Duplicated keys (" + str.toString() + ") are provided.");
    }
    ...
    public void s(Collection<CognitoIdentityProvider> collection) {
        if (collection == null) {
            ...
            this.f23963L = new ArrayList(collection);
        }
    }
    ...
    public void x(Collection<String> collection) {
        if (collection == null) {
            ...
            this.f23962K = new ArrayList(collection);
        }
    }
    ...
    public void y(Collection<String> collection) {
        if (collection == null) {
            ...
            this.f23964M = new ArrayList(collection);
        }
    }
