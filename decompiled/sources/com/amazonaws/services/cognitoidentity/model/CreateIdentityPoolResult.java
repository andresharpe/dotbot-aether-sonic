...
public class CreateIdentityPoolResult implements Serializable {
    ...
    private Map<String, String> f23942I;

    /* renamed from: J, reason: collision with root package name */
    private String f23943J;

    /* renamed from: K, reason: collision with root package name */
    private List<String> f23944K;

    /* renamed from: L, reason: collision with root package name */
    private List<CognitoIdentityProvider> f23945L;

    /* renamed from: M, reason: collision with root package name */
    private List<String> f23946M;

    /* renamed from: N, reason: collision with root package name */
    private Map<String, String> f23947N;
    ...
    public CreateIdentityPoolResult D(CognitoIdentityProvider... cognitoIdentityProviderArr) {
        if (g() == null) {
            this.f23945L = new ArrayList(cognitoIdentityProviderArr.length);
        }
        for (CognitoIdentityProvider cognitoIdentityProvider : cognitoIdentityProviderArr) {
            this.f23945L.add(cognitoIdentityProvider);
        }
        return this;
    }
    ...
    public CreateIdentityPoolResult J(String... strArr) {
        if (l() == null) {
            this.f23944K = new ArrayList(strArr.length);
        }
        for (String str : strArr) {
            this.f23944K.add(str);
        }
        return this;
    }
    ...
    public CreateIdentityPoolResult L(String... strArr) {
        if (m() == null) {
            this.f23946M = new ArrayList(strArr.length);
        }
        for (String str : strArr) {
            this.f23946M.add(str);
        }
        return this;
    }
    ...
    public CreateIdentityPoolResult a(String str, String str2) {
        if (this.f23947N == null) {
            this.f23947N = new HashMap();
        }
        if (!this.f23947N.containsKey(str)) {
            this.f23947N.put(str, str2);
            return this;
        }
    ...
    public CreateIdentityPoolResult b(String str, String str2) {
        if (this.f23942I == null) {
            this.f23942I = new HashMap();
        }
        if (!this.f23942I.containsKey(str)) {
            this.f23942I.put(str, str2);
            return this;
        }
        throw new IllegalArgumentException("Duplicated keys (" + str.toString() + ") are provided.");
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (createIdentityPoolResult.i() == null) {
            z3 = true;
        } else {
            z3 = false;
        }
        ...
        if (createIdentityPoolResult.j() == null) {
            z5 = true;
        } else {
            z5 = false;
        }
        ...
        if (createIdentityPoolResult.f() == null) {
            z7 = true;
        } else {
            z7 = false;
        }
        ...
        if (createIdentityPoolResult.e() == null) {
            z9 = true;
        } else {
            z9 = false;
        }
        ...
        if (createIdentityPoolResult.n() == null) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        if (createIdentityPoolResult.h() == null) {
            z13 = true;
        } else {
            z13 = false;
        }
        ...
        if (createIdentityPoolResult.l() == null) {
            z15 = true;
        } else {
            z15 = false;
        }
        ...
        if (createIdentityPoolResult.g() == null) {
            z17 = true;
        } else {
            z17 = false;
        }
        ...
        if (createIdentityPoolResult.m() == null) {
            z19 = true;
        } else {
            z19 = false;
        }
        ...
        if (createIdentityPoolResult.k() == null) {
            z21 = true;
        } else {
            z21 = false;
        }
    ...
    public void s(Collection<CognitoIdentityProvider> collection) {
        if (collection == null) {
            ...
            this.f23945L = new ArrayList(collection);
        }
    }
    ...
    public void x(Collection<String> collection) {
        if (collection == null) {
            ...
            this.f23944K = new ArrayList(collection);
        }
    }
    ...
    public void y(Collection<String> collection) {
        if (collection == null) {
            ...
            this.f23946M = new ArrayList(collection);
        }
    }
