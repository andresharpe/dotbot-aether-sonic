...
public final class C0741d {
    ...
    @l3.d
    public static final Bundle b(@l3.d Pair<String, ? extends Object>... pairs) {
        ...
        for (Pair<String, ? extends Object> pair : pairs) {
            ...
            if (b4 == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    kotlin.jvm.internal.F.n(b4, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(a4, (Parcelable[]) b4);
                } else if (String.class.isAssignableFrom(componentType)) {
                    kotlin.jvm.internal.F.n(b4, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(a4, (String[]) b4);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    kotlin.jvm.internal.F.n(b4, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
                    bundle.putCharSequenceArray(a4, (CharSequence[]) b4);
                } else if (Serializable.class.isAssignableFrom(componentType)) {
                    bundle.putSerializable(a4, (Serializable) b4);
                } else {
                    throw new IllegalArgumentException("Illegal value array type " + componentType.getCanonicalName() + " for key \"" + a4 + kotlin.text.F.f52746b);
                }
            } else if (b4 instanceof Serializable) {
                bundle.putSerializable(a4, (Serializable) b4);
            } else if (b4 instanceof IBinder) {
                C0739b.a(bundle, a4, (IBinder) b4);
            } else if (b4 instanceof Size) {
                C0740c.a(bundle, a4, (Size) b4);
            } else if (b4 instanceof SizeF) {
                C0740c.b(bundle, a4, (SizeF) b4);
            } else {
