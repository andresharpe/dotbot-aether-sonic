...
public class c {
    ...
    public static class b<T extends a> extends MediaController.Callback {
        ...
        public void onAudioInfoChanged(MediaController.PlaybackInfo playbackInfo) {
            this.f4410a.b(playbackInfo.getPlaybackType(), C0033c.c(playbackInfo), playbackInfo.getVolumeControl(), playbackInfo.getMaxVolume(), playbackInfo.getCurrentVolume());
        }

        @Override // android.media.session.MediaController.Callback
        public void onExtrasChanged(Bundle bundle) {
            MediaSessionCompat.b(bundle);
            this.f4410a.k(bundle);
        }

        @Override // android.media.session.MediaController.Callback
        public void onMetadataChanged(MediaMetadata mediaMetadata) {
            this.f4410a.a(mediaMetadata);
        }

        @Override // android.media.session.MediaController.Callback
        public void onPlaybackStateChanged(PlaybackState playbackState) {
            this.f4410a.c(playbackState);
        }
    ...
    public static class C0033c {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static final int f4411a = 4;

        /* renamed from: b, reason: collision with root package name */
        private static final int f4412b = 6;

        /* renamed from: c, reason: collision with root package name */
        private static final int f4413c = 7;
    ...
    public static class d {
        ...
        public static void l(Object obj, long j4) {
    ...
    public static void a(Object obj, int i4, int i5) {
    ...
    public static void u(Object obj, int i4, int i5) {
