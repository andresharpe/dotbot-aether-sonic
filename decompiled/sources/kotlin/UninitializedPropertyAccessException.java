...
public final class UninitializedPropertyAccessException extends RuntimeException {
    ...
    public UninitializedPropertyAccessException(@l3.e String str) {
        super(str);
    }

    public UninitializedPropertyAccessException(@l3.e String str, @l3.e Throwable th) {
        super(str, th);
    }

    public UninitializedPropertyAccessException(@l3.e Throwable th) {
        super(th);
    }
}
