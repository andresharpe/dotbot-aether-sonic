...
final class d0<K, V> implements c0<K, V> {
    ...
    @l3.d
    private final Map<K, V> f51917E;

    /* renamed from: F, reason: collision with root package name */
    @l3.d
    private final X2.l<K, V> f51918F;

    /* JADX WARN: Multi-variable type inference failed */
    public d0(@l3.d Map<K, V> map, @l3.d X2.l<? super K, ? extends V> lVar) {
    ...
    @Override // kotlin.collections.c0, kotlin.collections.T
    @l3.d
    public Map<K, V> f() {
        return this.f51917E;
    }
