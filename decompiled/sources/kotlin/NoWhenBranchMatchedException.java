...
public class NoWhenBranchMatchedException extends RuntimeException {
    ...
    public NoWhenBranchMatchedException(@l3.e String str) {
        super(str);
    }

    public NoWhenBranchMatchedException(@l3.e String str, @l3.e Throwable th) {
        super(str, th);
    }

    public NoWhenBranchMatchedException(@l3.e Throwable th) {
        super(th);
    }
}
