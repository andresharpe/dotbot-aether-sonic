...
public final class KotlinNothingValueException extends RuntimeException {
    ...
    public KotlinNothingValueException(@l3.e String str) {
        super(str);
    }

    public KotlinNothingValueException(@l3.e String str, @l3.e Throwable th) {
        super(str, th);
    }

    public KotlinNothingValueException(@l3.e Throwable th) {
        super(th);
    }
}
